...
function iniciarCapituloNarrativo(capitulo, modoRevisao) {
    ...
    narracaoState.modoRevisao = !!modoRevisao;

    if (!narracaoState.modoRevisao) {
...
function finalizarCapituloNarrativo() {
    ...
    narracaoState.bloqueado = false;
    narracaoState.capituloAtual = null;
    narracaoState.capituloAtualId = null;
    narracaoState.cenaAtualIndex = 0;
...
function abrirCapituloNarrativoPorId(capituloId) {
    ...
    if (
        player &&
        player.narrativa &&
        Array.isArray(player.narrativa.capitulosVistos)
    ) {
        jaVisto = player.narrativa.capitulosVistos.includes(capitulo.id);
    }

    iniciarCapituloNarrativo(capitulo, jaVisto);
}
// ============================================
